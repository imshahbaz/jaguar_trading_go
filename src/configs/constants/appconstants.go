...
var Strategies = []strategy{
	...
	{Name: "EMACD", Clause: "( {46553} ( latest close > latest ema( latest close , 21 ) and latest macd line( 26 , 12 , 9 ) > latest macd signal( 26 , 12 , 9 ) and 1 day ago  macd line( 26 , 12 , 9 ) <= 1 day ago  macd signal( 26 , 12 , 9 ) ) )", Active: false},
}
